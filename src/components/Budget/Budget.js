          ...
          <div className='content-container'>
            <div className="purchases-container">
              <AddPurchase
                ...
                requestPurchases={this.props.requestBudgetData}
               />
              <DisplayPurchases
...
export default connect(mapPropsToState,{requestUserData, requestBudgetData, addPurchase, removePurchase})(Budget);
